...
/**
 * @file plugins/generic/audioPlayer/tests/LocaleFilesTest.php
 *
...
class LocaleFilesTest extends PKPTestCase
{
    ...
    public function testShipsExactlyTheLocaleCodesOfThisLine(): void
    {
        ...
        // A code from another OMP line (fr vs fr_FR, pt vs pt_PT) silently never loads.
    ...
    public function testEveryKeyTheCodeUsesExists(): void
    {
        ...
        preg_match_all('/plugins\.generic\.audioPlayer\.[a-zA-Z0-9_.]*[a-zA-Z0-9_]/', $sources, $m);
